...
public class Student {
    ...
    @JsonIgnoreProperties({"students", "password"}) // Ignore these properties in mentor
	...
	public Student(Long registrationNumber, String fullName, String fatherGuardianName, String email, String dob,
			...
			String batch, String department, String password, Mentor mentor) {
		super();
		this.registrationNumber = registrationNumber;
		this.fullName = fullName;
		this.fatherGuardianName = fatherGuardianName;
	...
	public String toString() {
		return "Student [registrationNumber=" + registrationNumber + ", fullName=" + fullName + ", fatherGuardianName="
				+ fatherGuardianName + ", email=" + email + ", dob=" + dob + ", gender=" + gender + ", nationality="
				+ nationality + ", religion=" + religion + ", emergencyContact=" + emergencyContact + ", phoneNumber="
				+ phoneNumber + ", localAddress=" + localAddress + ", permanentAddress=" + permanentAddress + ", city="
				+ city + ", state=" + state + ", zipCode=" + zipCode + ", admissionNumber=" + admissionNumber
				+ ", applicationNumber=" + applicationNumber + ", feeCategory=" + feeCategory + ", dateOfAdmission="
				+ dateOfAdmission + ", program=" + program + ", branch=" + branch + ", semester=" + semester
